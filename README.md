...
<div style="
  ...
  padding:5px;  /* αυτό θα δείξει το border γύρω από τις εικόνες */
">
  <img src="./assets/homepage.gif" width="300" height="521" />
  <img src="./assets/register.gif" width="300" height="521" />
</div>
